...
<div class="col-md-6 col-md-offset-3" style="padding-top:70px">
  ...
  'placeholder' => 'Nombre de la pintura', 'default'=>$nombre, 'label' => false))."<span class='textfieldRequiredMsg'>Debes ingresar el nombre de la Pintura.</span></span>"; ?>

  <?php echo "<span id='sprytextfield4'>".$this->Form->input('painting_high', array('empty' => false, 'class' => 'form-control', 'div' => 'form-group',
  'placeholder' => 'Alto (en cm)', 'default'=>$alto, 'label' => false))."<span class='textfieldRequiredMsg'>Debes ingresar la altua.</span><span class='textfieldInvalidFormatMsg'>La altura debe ser un número.</span></span>"; ?>

  <?php echo "<span id='sprytextfield6'>".$this->Form->input('painting_width', array('empty' => false, 'class' => 'form-control', 'div' => 'form-group',
  'placeholder' => 'Ancho (en cm)', 'default'=>$ancho, 'label' => false))."<span class='textfieldRequiredMsg'>Debes ingresar la anchura.</span><span class='textfieldInvalidFormatMsg'>La anchura debe ser un número.</span></span>"; ?>

  <?php echo $this->Form->input('id_technique', array('options' => $techniques, 'class' => 'form-control', 'div' => 'form-group',
  'default'=>$tecnica, 'label' => false)); ?>

  <?php echo $this->Form->input('id_type', array('options' => $types, 'class' => 'form-control', 'div' => 'form-group',
  'default'=>$tipo, 'label' => false)); ?>

  <?php echo $this->Form->input('id_painter', array('options' => $painters, 'class' => 'form-control', 'div' => 'form-group',
  'default'=>$pintor, 'label' => false)); ?>

  <?php echo $this->Form->input('painting_sold', array('options' => array(1 => 'Vendida', 0 => 'No vendida'), 'class' => 'form-control', 'div' => 'form-group',
  'default'=>$vendida, 'label' => false)); ?>

  <?php echo "<span id='sprytextfield7'>".$this->Form->input('painting_year', array('empty' => false, 'class' => 'form-control', 'div' => 'form-group', 'label' => false, 'type' => 'text', 'minYear' => date('Y') - 104,
  'maxYear' => date('Y') - 0, 'placeholder' => 'Año', 'default'=>$anio))."<span class='textfieldRequiredMsg'>Debes ingresar el año.</span><span class='textfieldInvalidFormatMsg'>El año debe ser un número de cuatro dígitos.</span></span>"; ?>

  <?php echo "<span id='sprytextfield8'>".$this->Form->input('painting_price', array('empty' => false, 'class' => 'form-control', 'div' => 'form-group',
  'placeholder' => 'Precio de venta', 'default'=>$precio, 'label' => false))."<span class='textfieldRequiredMsg'>Debes ingresar un precio.</span><span class='textfieldInvalidFormatMsg'>El precio debe ser un número.</span></span>"; ?>
