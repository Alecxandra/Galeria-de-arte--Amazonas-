 ...
 *
 */
Configure::write('Routing.prefixes', array('hom'));
 ...
 */
	Configure::write('Security.salt', 'adflkajsdhflkqhroñ182yr9p128hrp98awdgp9w');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '3875973897507382570328530278591759');
